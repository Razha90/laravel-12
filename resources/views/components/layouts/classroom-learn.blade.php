...
<body class="bg-accent_grey min-h-screen">
    ...
    <div x-cloak x-data="{ alert: false, message: '' }"
        ...
        class="fixed z-50 bottom-3 left-3 mb-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow-sm dark:bg-gray-800 dark:text-gray-400"
        role="alert">
        <div
    ...
    <div x-cloak x-data="{ alert: false, message: '' }"
        ...
        class="absolute bottom-3 left-3 mb-4 flex w-full z-50 max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow-sm dark:bg-gray-800 dark:text-gray-400"
        role="alert">
        <div
