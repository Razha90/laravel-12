...
<nav class="fixed top-8 z-30 flex w-full items-center justify-center" x-data="init()" x-init="firstInit">
    ...
    <div
        ...
        <div class="flex flex-row items-center gap-x-4">
            ...
            <!-- <a href="{{ route('settings.profile') }}"
                class="border-secondary_blue h-[40px] w-[40px] overflow-hidden rounded-full border p-1 transition-opacity hover:opacity-50"
